            ...
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">Đồ ăn <span>/</span></a></li>
                            <li><a data-toggle="tab" href="#popular">Loại đồ ăn<span>/</span></a></li>
                            <li><a data-toggle="tab" href="#best">Đồ ăn</a></li>
